...
export default function LandingPageSection({ type, sectionData }) {
	const sectionsComponentPaths = () => ({
		hero: dynamic(
			() => import('@/components/landing-page-sections/hero')
				.catch(() => () => MissingSection), {
			loading: Preloader,
		}),
		two_column_with_image: dynamic(
			() => import('@/components/landing-page-sections/two-column-with-image')
				.catch(() => () => MissingSection), {
			loading: Preloader,
		}),
		features: dynamic(
			() => import('@/components/landing-page-sections/features')
				.catch(() => () => MissingSection), {
			loading: Preloader,
		}),
